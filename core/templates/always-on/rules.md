...
2. Keep long command output in files, not inline.

## Repository
3. Set your visibility/privacy policy here.
4. Never commit secrets or weights; gitignore first.

## Context Bootstrap
5. At task start: read portfolio + cross-links + context-registry. Load a project's file on demand.
